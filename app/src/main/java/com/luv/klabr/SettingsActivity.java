...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void saveUserData() {
        ...
        if (userNameET.getText().toString().contains(".") || userNameET.getText().toString().contains("#")
                || userNameET.getText().toString().contains("$") || userNameET.getText().toString().contains("[") ||
                userNameET.getText().toString().contains("]")){
            Toast.makeText(SettingsActivity.this, ". # $ [ ] symbols aren't allowed in username.", Toast.LENGTH_SHORT).show();
        } else {
